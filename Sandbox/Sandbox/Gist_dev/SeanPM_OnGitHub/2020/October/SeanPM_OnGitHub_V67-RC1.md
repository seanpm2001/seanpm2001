...
Today was a really tough day for me. I woke up early in pain of Mila dying, and her condition worsened this morning. She was in severe pain, and she was later put down. I didn't go to school today so that I could grieve. It has been really tough on me today, I felt emotions that I have never felt before.

I tried to distract myself with my usual activities. I resumed work on the WacOS project today, along with all the other daily projects I have been working on. Today was a bad day for me, but an OK day for development.
...
**This section was last updated on October 19th 2020 (10.19.2020)**
...
I further expanded the scope of my journaling archive on GitHub today, I added support for the daily-articles directory, but I won't be including most documents for some time due to privacy, security, sensitivity, safety, readiness, and other issues. The current planned full release date is May 15th 2040, or a week after I die, if before May 22nd 2040.

I also did a lot of Wiki work and finalizations today. Today was a very good day for development, my commit-rate has been building up rapidly for the past few days
...
I had an extremely good day with development today. I got work done in various projects, and I introduced further improvements to my journaling archive on GitHub, now uploading Minecraft backup data. I also made significant improvements to the daily articles project, along with various improvements to several other projects.

I got a lot done, my productivity has been going up rapidly in the past few days, I am positive it is going to drop tomorrow, as I won't be able to keep up this pace (this was my prediction back then, it has come true, there is no way I could casually get 400 commits in a day without some other form of commit manipulation to the usual workflow)
...
> * How to install images via Octet-stream appimage files (1. make the file executable, 2. run/execute the file)

> * The trash can icon in nautilus has a garbage bag next to it when the trash has data in it

> * No other Linux based discoveries from October 14th 2020
...
I worked further on the daily articles archive repository today, along with various other projects, including 3 more projects out of the 12 I scavenged for in early October 2020.

Today was an OK day for development today. I didn't do very much.
...
I worked on more finalizations and Wiki work today, along with importing older project data from 2018. I have really been holdding off the Gist update work.

I worked further on the daily articles archive repository, along with several other repositories. I had an OK day for development.
...
I had a weak day with development today, and I didn't get too much done. I did finalize work on the daily articles repository that I thought was going to take at least another 20 days, but I found an efficient lossless shortcut, and took it.

I recently came up with an idea for an addition to the Metric system. I was skeptical about uploading it to GitHub in fear of my account getting deleted, and not being credited, but since I have put so many other important projects on GitHub, I figured I could store this one as well. And thus, my public idea vault was founded. I will try to add other ideas here from time to time.
...
I had a really good day with development today. I was able to make progress on several projects, and finalize 75% of a project I have been working on this month, which was a GitHub archive of 12 super old projects (2018)

My month really has turned around. The first few days were bad, but it has gotten significantly better. I started to try and get Audacity to work again today, I want to get back into audio composition and graphic design, as I have noted that I have made some good graphics, and some decent audio, especially for an amateur with little experience.
...
Today was a good day for development. I decided to work from home today, as I want to social distance more, and I didn't feel like going in physically today. There have also been communication issues last week, and since my phone is so heavily damaged and that it no longer has a functioning SIM card, I decided to stay home, as 2 emergencies happened last week that could have been mitigated or avoided if I had a functioning phone.

I didn't receive any assignments, I checked nearly a hundred times. I got some work done on GitHub, but not as much as yesterday. It was still a pretty good amount. I have resumed work on my food index project today, as it is an important resource I need to better maintain. I also resumed work on my main GitHub Gist today, after over a month of no activity. I have been holding it off hard for weeks in favori of other projects, but I finally got to it today. There was too much to do in 1 night.

I have been trying hard to rip my Google Site again. Google should be offering full data downloads of their services, like they have been legally forced to. It seems like everything can be downloaded except the "new" Google Sites. It has become more unreasonable to try and get data from it. It took over an hour for me ot even be able to download resources on the current page. I tried HTTrack, but it completely failed on Ubuntu. I want to de-google further, and this is a huge problem still, that I haven't been able to solve since 2018.

I have also been getting Audacity to work. I found out that the whole time I couldn't get it to work was because the microphone permission wasn't set. I thought it was already set, as the microphone icon came up. I also had to turn up the microphone volume, but it was completely static, so I am going to have to continue testing it until I can get it to sound decent.

A huge graphical chance I made today was a complete re-make of my Ubuntu dock. I removed several programs from it, tried multiple locations and multiple icon sizes, and eventually settled.
...
> * `CTRL` + `D` acts as an End of Line break shortcut, and can exit out of modes, or close certain programs (such as Konsole)

> * No other Linux-based discoveries on October 19th 2020
...
Gist version: `66 (Thursday, September 17th 2020 at 10:41 pm)` - RC1 - August 22nd 2020 at 12:18 pm
