...
<!--
2022 May 26th GitHub status notes

Caught up on Git-image:binary.android
Gherkin IDE
Proton Issues resolved, still going to use pCloud for a while
Took time to name image files
Seanpm2001/Seanpm2001 Docs and issue templates, lots planned
Commit count issues, jumping back and forth
GitHub public changelog in feed for about a week, working great
SPM Food Index, not as many food/drink named languages as expected
Some image files named, everything but GitHub screenshots
!-->
...
I spent a lot of time naming image files today. I also plan to create docs for `seanpm2001/seanpm2001` which is going to take a long time. I also have plans for issue templates.
