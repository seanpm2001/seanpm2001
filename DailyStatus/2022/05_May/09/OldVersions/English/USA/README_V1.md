...
I took a break from WacOS work today to do other things. I started the basis for 2 new projects: BathHouseOS, and JScribe. They will be released on Friday. I also spent too much time using the [`@all-contributors`](https://github.com/All-Contributors/) bot with the Scarlet Oven repository. I didn't do anything else today on GitHub.
