...
- The Kiri voice assistant
- The WacOS API collection repository
- The WacOS "cloud" repository
- The WacPaint software repository
- The WacWrite software repository
- The Sir Isaac NewtonOS subsystem repository
- The Sir Isaac NewtonScript repository
