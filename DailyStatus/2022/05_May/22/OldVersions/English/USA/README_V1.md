...
Git-template V8 brief work

I was doing some research on other hobbyists attempts to learn and write in the language, some people said they had to write paper notes, as source code comments were too difficult. I also learnt that there is no standard way of writing brainfuck, so many implementations exist. I now have plans to revitalize my Brainfuck IDE based on these, I will include a separate notepad in the GUI, so that people can write comments, and I will try to support as many (hopefully all) variants of Brainfuck. I obviously will not be able to do this all myself, so I hope to get community support in the future. - 2022 May 22nd
