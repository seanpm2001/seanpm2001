...
- The new OnESTEP subsystem
- The WAMMY project
- The OpenCyberdog browser
- The 8 bit DOS mode subsystem
- The 4 bit DOS mode subsystem
- The OpenAPFS file system
- The Savannah web browser
- Hardware blueprints for WacOS
- The AMD driver hub for WacOS
- The openGS subsystem

This was also merged into the core repository. I also created a repository for ProtonMail images, and made the joke repository titled `Oh-Hi-Markdown` I worked on 23 repositories in total today. I didn't do anything else today on GitHub.
