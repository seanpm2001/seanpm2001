...
I stayed caught up on Git-image work (part A & part B) <!-- I also did further work on the SNU Blockchain ad system (which again, has been abandoned, as of writing this, due to ethical issues) !--> I did not delete `IGNORE.md` files en masse in my main GitHub images repository.

Today was day 14 of getting back into the project of archiving my programming language knowledge. I only updated the main [Learn](https://github.com/seanpm200/Learn/), I did not update any of the projects other repositories today.
...
Today, I got fully caught back up on Git-image part A work, and did heavy work on the Ruby version of Tap Pet Hotel Open. I also finalized the first release set for the AdVenture Communist part 2 image repo.
...
Although I did get caught up on Git-image work today, I am still far behind on my status posts.
...
Milly is still doing OK, I will keep logging her status here. She really seems like she will until her 15th birthday. She has made it to 15th birthday, and is still going strong, as of 2022, April 24th. She is having off days from time to time, but nothing too serious yet.
