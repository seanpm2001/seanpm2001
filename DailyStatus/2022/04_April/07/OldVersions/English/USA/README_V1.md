...
Today, I stayed caught up with Git-image work, although I failed to write a status post for today. Today, I worked on my DeGoogle-your-Life project, updating the main repository, and improving the `What the FLoC` repository. I also worked heavily on the Engineer superdesk project, and created a new SNU project: a blockchain ad system. (I would later abandon this project, as it is not possible to use Blockchain ethically)
...
Milly is still doing OK, I will keep logging her status here. She really seems like she will until her 15th birthday. She has made it to 15th birthday, and is still going strong.
