...
I fell behind on Git-image work (part B) <!-- I also did further work on the SNU Blockchain ad system (which again, has been abandoned, as of writing this, due to ethical issues) !--> I did not delete `IGNORE.md` files en masse in my main GitHub images repository.
...
Today, I did Git-image part A work, but not part B work. I worked heavily on the URLL Specification repository today, and learned how to fork projects again today (just not to an organization) the method I am using is:

1. Go to the repository homepage
2. Press [Add file] or go to edit any file
3. Go back to the homepage of the repository (optional)
4. Replace the username in the URL to your username
5. You are now in your forked version of the repository
...
Milly is still doing OK, I will keep logging her status here. She really seems like she will until her 15th birthday. She has made it to 15th birthday, and is still going strong, as of 2022, April 25th. She is having off days from time to time, but nothing too serious yet.
