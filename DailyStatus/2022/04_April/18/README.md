...
I stayed caught up on Git-image work (part A & B) <!-- I also did further work on the SNU Blockchain ad system (which again, has been abandoned, as of writing this, due to ethical issues) !--> I additionally deleted `IGNORE.md` files en masse in my main GitHub images repository. I finalized work for now on the V3 Tree World image repository, and got caught up on the V4 repository as well.

Today was day 8 of getting back into the project of archiving my programming language knowledge. I updated the main [Learn](https://github.com/seanpm200/Learn/) project, but didn't create any new repositories for today. <!-- and created repositories for showcasing my knowledge of the following 5 programming langages:
...
Additionally, I updated the Petland software repository, and the r/seanpm2001 subreddit repository.
...
<!--
2022.04.18 Status post notes

Finalized V3 Tree world repo
Caught up on V4 TW repo
Mass IGNORE.md file deletion in GitHub (images) main
6 learn repositories updated, along with the main one.
!-->
