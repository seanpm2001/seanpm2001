...
I stayed caught up on Git-image work (part A & B) <!-- I also did further work on the SNU Blockchain ad system (which again, has been abandoned, as of writing this, due to ethical issues) !-->

Today was the day of the week where I create organizations. A recent GitHub bug has made it so I can't fork repositories, other than to my own account, so the organizations created today were blank. I released 3 private projects that were in the works: [AquariOS](https://github.com/seanpm2001/AquariOS/), [Project Aquarius](https://github.com/seanpm2001/Project-Aquarius) and [Petland Software](https://github.com/seanpm2001/PetLand-Software/)

Today was day 5 of getting back into the project of archiving my programming language knowledge. I updated the main [Learn](https://github.com/seanpm200/Learn/) project, and created repositories for showcasing my knowledge of the following 5 programming langages:
...
I also updated the repositories for showcasing my knowledge of the following programming language:

- [x] Fortran

Additionally, I created 2 more repositories, one for the Petland software project, and one for the archival and development of my Reddit subreddit, r/seanpm2001
...
Milly is still doing OK, I will keep logging her status here. She really seems like she will until her 15th birthday. She has made it to 15th birthday, and is still going strong, as of 2022, April 13th.
