...
I had a good day with development again today. I am still struggling to stay caught up, but I am slowly getting there. It has been a struggle since 2021 December 28th

I stayed caught up on Git-image work (part B, but not part A) <!-- I also did further work on the SNU Blockchain ad system (which again, has been abandoned, as of writing this, due to ethical issues) !--> I did not delete `IGNORE.md` files en masse in my main GitHub images repository.

Today was day 13 of getting back into the project of archiving my programming language knowledge. I only updated the main [Learn](https://github.com/seanpm200/Learn/), I did not update any of the projects other repositories today.
...
Today, I started 2 new private projects: AcroSlideX, and Tap Pet Hotel Open (modern version, written in Ruby) the projects are starting out private, but will be made public next Friday.

With Git-image part A work today, I created a part 3 AdVenture Communist image repository, and I started to make progress on geting caught up.

Additionally today, I updated my GitHub backup tool, and my V8 GitHub repository template.
...
I got partially caught back up on Git-image part A work today, and stayed caught up with Git-image part B work. I am still far behind on my status posts.
...
Milly is still doing OK, I will keep logging her status here. She really seems like she will until her 15th birthday. She has made it to 15th birthday, and is still going strong, as of 2022, April 23rd. She is having off days from time to time, but nothing too serious yet.

<!--
2022 April 20th GitHub notes

No IGNORE.md file deletion
5 new learn repos, major renovations
Catching up on image file naming
Commit miscalculation/commit deletion by GitHub, no notif
More notes needed
!-->
