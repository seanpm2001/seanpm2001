...
My scheduled plans for today didn't go well, I went to bed early, but woke up way later. I also had more leisure time than as of lately, and didn't get as much done today.

I stayed caught up on Git-image work (part B, but not part A) <!-- I also did further work on the SNU Blockchain ad system (which again, has been abandoned, as of writing this, due to ethical issues) !--> I additionally deleted `IGNORE.md` files en masse in my main GitHub images repository.

Today was day 9 of getting back into the project of archiving my programming language knowledge. I updated the main [Learn](https://github.com/seanpm200/Learn/) project, but didn't create any new repositories for today. <!-- and created repositories for showcasing my knowledge of the following 5 programming langages:
...
Additionally, I got caught back up on my Raspberry Pi blog today.
...
Milly is still doing OK, I will keep logging her status here. She really seems like she will until her 15th birthday. She has made it to 15th birthday, and is still going strong, as of 2022, April 18th.

<!--
GitHUb status notes 2022 April 19th

6 learn repos updated, 5 big updates, separate from main repo (7 total)
Raspberry PI booted successfully
Todays schedule plans didn't go well (went to bed early, woke up way later)
Raspberry Pi blog up to date
More leisure time than as of lately
Not much done today
Mass IGNORE.md file deletion day 2
!-->
