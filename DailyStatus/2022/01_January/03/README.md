...
🎂 **Days until 2 year GitHub :octocat: anniversary:** `141` _(as of 2022 January 3rd at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #1 !-->

:octocat: **GitHub consecutive day count:** `589` _Count revised and updated on July 16th 2021 via_ [DuckDuckGo](https://duckduckgo.com/?t=ffab&q=Days+since+May+25th+2020&ia=answer) _(As of 2022 January 3rd at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #2 !-->

🐧 **Linux desktop consecutive day count:** `544` _(as of 2022 January 3rd at 00:12:00 am to 11:59:59)_  <!-- COUNTER #3 !-->
...
🐧 **Ubuntu 20.04 with GitHub consecutive day count:** `544`  _(as of 2022 January 3rd at 00:12:00 am to 11:59:59)_  <!-- COUNTER #5 !-->

:atom: **Total amount of original GitHub repositories:** `1,629+o` _(as of 2022 January 3rd at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #6 !-->
...
:atom: o=organizations, total number of non-fork organization repositories: `115` _as of 2022 January 2nd 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #7 !-->
...
:electron: **Repositories created so far this month:** `5+o` _(as of 2022 January 3rd at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #8 !-->

:shipit: **Organization count:** `760` _(as of 2022 January 3rd at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #9 !-->

:electron: **Organizations created so far this month:** `0` _(as of 2022 January 3rd at 00:12:00 am to 11:59:59 pm)_ <!-- COUNTER #10 !-->
...
Today, I also worked a bit on my V8 template, and finally got to changing my status on my GitHub profile from `📎️ Clippy` to `🐍️ Python 4` which I came up with on the fly. I find it unique, as it gives a little mystique to some, such as "what does this person know about Python 4" but it can also be used jokingly. I wanted to change it, as it was obvious that Microsoft wasn't going to turn Clippy into an Emoji for GitHub, despite its announcement for another Microsoft product 5+ months ago. It is something I hardly spend time on.

I worked on 2 IDE projects today that I recently had the idea for. The first one, known as **DIFF**icult, is a Diff viewer and editor written in D, R, C, and Diff. I really liked the name, and wanted to experiment with Diff files. Despite the name being `difficult` it is not difficult to use. The other project is an IDE known as `Zag` which is an IDE for the Zig programming language. If you combine the 2 words, it is called `zigzag` which is where the name comes from.
...
I failed to catch up on Marine Biology documentation tasks today. - 2021 December 16th to 2022 January 3rd
