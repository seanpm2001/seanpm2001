...
<!-- Notes 2022.03.10
2022.03.10 STATUS POST NOTES

README improvements, Arabic translation
Continued work on getting caught up
KA repo updated, caught up
Mass distraction
Facebook, won't recognize their "meta" name, word is already too common
Mass forks, less than yesterday
DuckDuckGo controversy, will continue using until further notice, NEVER going back to Google, will switch to Ecosia if things get worse, if that fails, there is still Bing. Still looking for other backup options
!-->
