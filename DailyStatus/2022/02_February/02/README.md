...
### Status update: 2022 February 2nd
...
Today I worked on my primary journaling article documentation repositories and started some new side tasks instead of getting caught up, the main one from today being the `Bandwidth_Band` project, which is a set of tools regarding bandwidth and automation.

I finally decided to give myself the go-ahead on forking GNU Radio repositories, although I am still very confused by the structure of it, as it seems to go against what the Free Software Foundation stands for in some ways, such as reliance on Google for certain parts of the radio. I also recently discovered the video game series Prince of Persia, and forked some open source repositories related to it.
