...
### Status update: 2022 February 22nd
...
<!-- Notes 2022.02.22
Mass progress on OSData
Falling behind on other tasks
Continued work on Linux Defender and its ports
AUTOMATE2001 Automation todo file
Massive increase in popularity, over 1/3 of the way to 1k followers
!-->
...
I made massive progress on my OSData project, but fell behind on other tasks. Today, I also continued to do work on Linux Defender and its port projects. A new monthly specification/API update was made, there is now a file called `AUTOMATE2001.yml` that is an index to tell the [`@AUTOMATE-2001`](https://github.com/AUTOMATE-2001) what to automate in a project. The standard V2 syntax looks like this:
...
I have also been having a massive increase in popularity, and now am over 1/3 of the way to 1.000k followers. I still don't have as many reactions as I expected/wanted.
