...
### Status update: 2022 February 8th
...
Today I worked mainly on SNU Web IDE projects. I started 2 projects in private: `IsraeLinux` and `Teams` which are going to be made public by the end of the month. I decided to chop my status post up, and cust most of the bloat out, going back to the old way of doing it. I did less forks today, and did no Git-image work. That was it for today.
