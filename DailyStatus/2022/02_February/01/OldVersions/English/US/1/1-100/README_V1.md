...
### Status update: 2022 February 1st
...
Today I worked mainly on my OS data project, a project I have held off for nearly 2 exact full years (off by only 1 day) I worked on the Android section of this, and dealt with a computer crash, as Gedit can't handle HTML or XML that well. I also did limited Git-image work, and work on purging `IGNORE.md` files from my 2020 GitHub image repo. That was it for today.
