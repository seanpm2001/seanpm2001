...
### Status update: 2022 February 24th
...
<!-- Notes 2022.02.24
Mass work on AZWS Decryption
Trying to get caught up
Image file naming false
A lot less work on Linux Defender
Beacon raising 2001
!-->
...
I worked a lot on a new project known as `AZWS Encryption` which is a really weak encryption similar in style to l33tsp3@k. I have realized that although an ENIAC could easily crack this encryption in minutes, it is a good exercise for basic algorithms in computer programming. I worked on preparing the codespaces for various languages, and hope to see recognition in a computer science class, even if it is just a hobbyist/extra project.

I worked on trying to get caught up, and failed on naming image files. I did a lot less work on the Linux Defender project today, and spent a lot more time raising `AUTOMATE2001` beacons (the `AUTOMATE2001.yml` file at the root of the repository) I didn't do much else today.
