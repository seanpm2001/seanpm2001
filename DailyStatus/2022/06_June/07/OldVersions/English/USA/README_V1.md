...
<!-- Todays notes
2022 Tuesday, June 7th GitHub status notes

WacOS project language file work
Criticizing my WacOS workflow, a problem for myself
Git-image work catchup
Further WacOS plans
WacOS JRE setup, very basics of the foundation
Still behind on GitHub status posts
!-->
...
I worked heavily on the WacOS project, and I got caught up on Git-image part A & B work today. <!-- I created 9 repositories today, 3 of them are forks, the other 6 were WacOS subsystem home repositories. !--> I didn't do anything else today on GitHub.
